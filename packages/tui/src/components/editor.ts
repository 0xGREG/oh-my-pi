...
export class Editor implements Component, Focusable {
	...
	/** Display width of the cursorOverride glyph; when unset, the glyph's measured width is used. */
			...
			if (!isSideBordered && lineContentWidth === 0) {
				if (hasCursor && !this.#useTerminalCursor) {
					...
					const zeroWidthCursorReplacement = this.cursorOverride
						? { text: this.cursorOverride, width: this.cursorOverrideWidth ?? visibleWidth(this.cursorOverride) }
