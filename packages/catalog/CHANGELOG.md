...
- Devin discovery falls back to the legacy Windsurf catalog when native discovery returns only the seed models, restoring Enterprise credential-scoped models ([#12858](https://github.com/can1357/oh-my-pi/pull/12858) by [@roboomp](https://github.com/roboomp)).
