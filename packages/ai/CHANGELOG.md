...
- OpenAI-compatible chat responses that consist only of structured tool calls now report time-to-first-token instead of leaving it blank ([#12213](https://github.com/can1357/oh-my-pi/pull/12213) by [@STRML](https://github.com/STRML)).
