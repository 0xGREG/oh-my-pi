...
- Added `fitOutputTokensToContextWindow` to lower a request's output cap so prompt plus output fits the model's context window ([#13135](https://github.com/can1357/oh-my-pi/issues/13135))
