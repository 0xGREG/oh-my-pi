...
- Fixed subagents losing their configured retry fallback chain when their primary model is also the default model ([#12368](https://github.com/can1357/oh-my-pi/issues/12368)).
