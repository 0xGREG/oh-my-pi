...
- Editing files with invalid UTF-8 now fails without rewriting unrelated bytes. ([#12277](https://github.com/can1357/oh-my-pi/pull/12277) by [@iliaal](https://github.com/iliaal))
